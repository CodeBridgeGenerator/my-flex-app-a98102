...
const ServicerecordsPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .find({ query: { $limit: 10000 , invoiceId : urlParams.singleInvoicesId ,serviceId : urlParams.singleServicesId ,vehicleId : urlParams.singleVehiclesId ,technicianId : urlParams.singleTechniciansId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
