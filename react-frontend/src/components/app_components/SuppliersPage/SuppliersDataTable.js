...
const inputTextareaTemplate4 = (rowData, { rowIndex }) => <p >{rowData.address}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="supplierName" header="Supplier Name" body={pTemplate0} filter={selectedFilterFields.includes("supplierName")} hidden={selectedHideFields?.includes("supplierName")}  sortable style={{ minWidth: "8rem" }} />
<Column field="contactPerson" header="Contact Person" body={pTemplate1} filter={selectedFilterFields.includes("contactPerson")} hidden={selectedHideFields?.includes("contactPerson")}  sortable style={{ minWidth: "8rem" }} />
<Column field="phoneNumber" header="Phone Number" body={pTemplate2} filter={selectedFilterFields.includes("phoneNumber")} hidden={selectedHideFields?.includes("phoneNumber")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="address" header="Address" body={inputTextareaTemplate4} filter={selectedFilterFields.includes("address")} hidden={selectedHideFields?.includes("address")}  sortable style={{ minWidth: "8rem" }} />
