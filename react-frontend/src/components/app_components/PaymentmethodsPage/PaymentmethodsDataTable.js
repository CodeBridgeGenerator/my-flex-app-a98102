...
const inputTextareaTemplate1 = (rowData, { rowIndex }) => <p >{rowData.description}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="methodName" header="Method Name" body={pTemplate0} filter={selectedFilterFields.includes("methodName")} hidden={selectedHideFields?.includes("methodName")}  sortable style={{ minWidth: "8rem" }} />
