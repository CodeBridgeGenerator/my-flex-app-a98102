...
const dropdownTemplate4 = (rowData, { rowIndex }) => <p >{rowData.supplierId?.supplierName}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="partName" header="Part Name" body={pTemplate0} filter={selectedFilterFields.includes("partName")} hidden={selectedHideFields?.includes("partName")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="quantityInStock" header="Quantity In Stock" body={p_numberTemplate2} filter={selectedFilterFields.includes("quantityInStock")} hidden={selectedHideFields?.includes("quantityInStock")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="supplierId" header="SupplierID" body={dropdownTemplate4} filter={selectedFilterFields.includes("supplierId")} hidden={selectedHideFields?.includes("supplierId")}  style={{ minWidth: "8rem" }} />
