...
const pTemplate4 = (rowData, { rowIndex }) => <p >{rowData.specialization}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="firstName" header="First Name" body={pTemplate0} filter={selectedFilterFields.includes("firstName")} hidden={selectedHideFields?.includes("firstName")}  sortable style={{ minWidth: "8rem" }} />
<Column field="lastName" header="Last Name" body={pTemplate1} filter={selectedFilterFields.includes("lastName")} hidden={selectedHideFields?.includes("lastName")}  sortable style={{ minWidth: "8rem" }} />
