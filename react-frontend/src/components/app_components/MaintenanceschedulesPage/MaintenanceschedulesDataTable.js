...
const p_calendarTemplate2 = (rowData, { rowIndex }) => <p >{rowData.nextServiceDate}</p>
...
<Column field="nextServiceDate" header="Next Service Date" body={p_calendarTemplate2} filter={selectedFilterFields.includes("nextServiceDate")} hidden={selectedHideFields?.includes("nextServiceDate")}  sortable style={{ minWidth: "8rem" }} />
